...
| 关于茶水间 (・_・).｡oO | About tea room ☕️ (・_・).｡oO| 
...
| 👥 | ㊥ | ☕️
|----------|----------|----------|
| 赛鸽俱乐部 | 桌游设计的大失败 | A Great Failure in Board Game Design |
| 钟律师 | 桌游版权保护笔记分享 | Notes on Board Game Copyright Protection |
| 陈高远狠活工作室| 我的游戏官网是个学校官网 | [My Game’s Official Website Is a School Website](http://gpieschool.com/) |
| [锐深](https://automatism.cargo.site/)| 手机维修店办展览&用石头做石头  | An exhibitions in a phone repair shop & making stones out of stones |
|[Danni](https://b23.tv/2Gvd2oZ)| 以“屏幕景观”为转译媒介的视觉探索 |Visual explorations using the “screen landscape” as a medium of translation|
|Cyanarrow | 用牵手打破世界规则的双人冒险游戏 |A two-player adventure game that breaks the world’s rules through hand-holding|
|狗红|由感情创伤联想出的游戏机制 | Game mechanics inspired by emotional trauma|
| 7acques |在掌机上玩自己做的游戏 | Playing self-made games on a portable console|
...
| 👥 | ㊥ | ☕️
|----------|----------|----------|
| [@v10101a](https://viola.city)   | 做一个（美丽的）（个人）网站| Making a (beautiful) (personal) website |
...
| 云漾 | 手书分享 | hand-drawn animation sharing |
| 7k | 想象一个人文社科学者的Github | imagining a GitHub for humanities scholars |
| Jon | 立直麻将（日麻），一款人生模拟器 | Riichi Mahjong — a life simulator |
| SaSa | unity制作一个摄像头交互作品。 | a camera-based interactive piece made in Unity |
| 小孔 | 制作中的定格动画项目，通过人物世界中抽象形体的变化，表现直面原初不安全感的内心过程。 | a stop-motion project in progress — using the transformation of abstract forms to depict the inner process of confronting primal insecurity |
| RA0306 | 使用TouchDesigner制作的音画交互系统，连接midi现场演奏将点亮画面中的音柱。灵感源于音乐中的十二平均律。音柱的图像设计也和贝壳式的对数螺旋形态一致。 | an audiovisual interactive system built with TouchDesigner, linking MIDI performance to illuminate sound columns — inspired by twelve-tone equal temperament and the logarithmic spiral of shells |
| 刀刀 | 跟朋友们在便利店做Screen-Free小游戏然后卖掉 | making and selling screen-free mini games with friends at a convenience store |
